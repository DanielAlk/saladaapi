class ProductSerializer < ActiveModel::Serializer
  attributes :id, :user_id, :title, :stock, :price, :description, :cover, :status, :special, :is_retailer, :wholesaler_amount, :shipping_amount, :retailer_price, :shipping_price, :video_id, :rating, :provider_product, :minimum_amount, :available_at, :is_package, :package_amount, :package_price, :is_associate, :associate_amount, :associate_price, :is_promoted
