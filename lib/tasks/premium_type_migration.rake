namespace :premium_type_migration do
	...
	task script: :environment do
		...
		wholesaler_plan = PlanGroup.create(name: 'wholesaler_cash', title: 'Pack Mayorista Contado', description: plan_group_description, kind: PlanGroup.kinds[:cash], subscriptable_role: User.roles[:seller], starting_price: 199.99, premium_type: PlanGroup.premium_types[:wholesaler])
		fairsaler_plan = PlanGroup.create(name: 'fairsaler_cash', title: 'Pack Feriante Contado', description: plan_group_description, kind: PlanGroup.kinds[:cash], subscriptable_role: User.roles[:seller], starting_price: 199.99, premium_type: PlanGroup.premium_types[:fairsaler])
	...
	task script_providers: :environment do
		...
		wholesaler_plan = PlanGroup.create(name: 'wholesaler_provider_cash', title: 'Pack Mayorista Proveedor Contado', description: plan_group_description, kind: PlanGroup.kinds[:cash], subscriptable_role: User.roles[:provider], starting_price: 199.99, premium_type: PlanGroup.premium_types[:wholesaler])
		fairsaler_plan = PlanGroup.create(name: 'fairsaler_provider_cash', title: 'Pack Feriante Proveedor Contado', description: plan_group_description, kind: PlanGroup.kinds[:cash], subscriptable_role: User.roles[:provider], starting_price: 199.99, premium_type: PlanGroup.premium_types[:fairsaler])
		premium_plan = PlanGroup.create(name: 'premium_provider_cash', title: 'Pack Premium Proveedor Contado', description: plan_group_description, kind: PlanGroup.kinds[:cash], subscriptable_role: User.roles[:provider], starting_price: 199.99, premium_type: PlanGroup.premium_types[:shedsaler])
